...
if __name__ == "__main__":
    ...
    # general parameters
    parser.add_argument('--datatype', type=str, default='brca', help='datasets separated with ,')
    parser.add_argument('--opt_k', type=str, default='', help='optimal Ks separated with ,')
